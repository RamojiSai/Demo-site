  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn about Port AI Technologies - a technology-driven engineering and CAD services company delivering precision-focused solutions for complex industrial projects."
        />
      </Helmet>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
              <div>
                ...
                <p className="text-muted-foreground text-lg leading-relaxed mb-6">
                  Port AI Technologies is a technology-driven engineering and CAD services 
