  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Port AI Technologies delivers precision-focused engineering and CAD solutions for Oil & Gas, Petrochemical, Power, and Process Industries. Expert plant engineering services in Hyderabad, India."
        />
        <meta
          name="keywords"
